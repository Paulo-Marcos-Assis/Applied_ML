#!/usr/bin/env python3
"""
Task 4c — Vetorização Albertina-Base e Albertina-Large apenas
(BERT-Base e BERT-Large já concluídos no task4b)
...
MODELS = {
    "albertina_base": "PORTULAN/albertina-ptbr-base",
    "albertina_large": "PORTULAN/albertina-ptbr-large",
}
...
def main():
    print("=" * 70)
    print("TASK 4c — ALBERTINA (Base + Large)")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("TASK 4c CONCLUÍDA — Albertina")
    print("=" * 70)
